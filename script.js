...
//SCHOOL = "MySchool"
// the error is that we tried to reassign a constant and this is porhabted in java script and give a type Error 
...
console.log(2+"3")
console.log(2+3)
// when one of the two parts is a string it convert the other one to a string too so the first two examples become a string while the last one did not
...
// the let will not work out side the scoop but the var will work 
...
console.log("the length of the array is 4 and the final array is : "+ nums)
